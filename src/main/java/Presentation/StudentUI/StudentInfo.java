...
public class StudentInfo extends JFrame {
	...
	public StudentInfo(boolean edit, int id) {
		...
		idSP = av.getStudentProfileId(student);
		...
		if(!edit)
		{
			if(idSP != -1)
			{
				...
				btnEnroll.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if(ve.populateViewEnrolled(idSP))
						{
							System.out.println("Enrolled -> SetVisible");
							ve.setVisible(true);
						}
						
						else
						{
							System.out.println("Enrolled -> SetInvisible");
							setVisible(false);
							StudentInfo frame = new StudentInfo(false,idSP);
							frame.populateFields(idSP);
							frame.setVisible(true);
						}
					}
			...
			btnEdit.addActionListener(new ActionListener() {
				...
				{
					setVisible(false);
					StudentInfo frame = new StudentInfo(true,idSP);
					frame.populateFields(idSP);
					frame.setVisible(true);
				}
			});
